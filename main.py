...
# Creates a GET on the root giving a welcome message
@app.get("/")
async def get_root():
    """ Say hello!"""
...
async def post_inference(data: Data):
    ...
    _inference = inference(model, data_processed) # predicts the result using data_processed
    return apply_label(_inference)
